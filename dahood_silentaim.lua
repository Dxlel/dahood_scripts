...
-- // INFORMACION:
-- silent aim/aimlock que "predice" el movimiento del jugador
...
thisaudiowasmadebytueniSEXdrip:SetCore("SendNotification",{
    Title="TECHWARE 最好的代碼",
    Text = "APRETA LA TECLA "..teclas.tecla3.." PARA ACTIVAR EL AIMLOCK"
})
thisaudiowasmadebytueniSEXdrip:SetCore("SendNotification",{
    Title="TECHWARE 最好的代碼",
    Text = "APRETA LA TECLA "..teclas.tecla2.." PARA DESLOCKEAR"
})
thisaudiowasmadebytueniSEXdrip:SetCore("SendNotification",{
    Title="TECHWARE 最好的代碼",
    Text = "APRETA LA TECLA "..teclas.tecla1.." PARA LOCKEAR A ALGUIEN\n(pon el mouse sobre la persona que quieres lockear)"
})
...
mordida_del_87.KeyDown:Connect(function(AMONGUS)
    if AMONGUS:lower() == teclas.tecla1:lower() then
    ...
    elseif AMONGUS:lower() == teclas.tecla3:lower() then
